...
<head>
  ...
  <script src="/parser_rules/advanced_and_extended.js"></script>
	...
	<title>Editing comment # {{ $comment->id }}</title>
...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
          ...
          {!! Form::open(['action' => ['CommentController@update', $comment->id], 'class' => 'form-horizontal']) !!}
          ...
          <div class="form-group">
            <label for="comment" class="col-sm-2 control-label">{{ trans('tables.comment') }}</label>
              <div class="col-sm-10">
                ...
                {!! Form::textarea('comment', $comment->text, ['class' => 'form-control', 'rows' => 20, 'id' => 'wysihtml-textarea']) !!}
              </div>
          </div>
          <div class="form-group">
