...
{!! Form::open(['action' => 'PenaltyController@update']) !!}
{!! Form::hidden('penalty_id', $penalty->id)!!}
...
<div class="form-group">
  ...
  <div class="col-sm-2">
    {!! Form::select('currency', [
                      ...
                      ], $penalty->currency, ['class' => 'form-control']) !!}
  </div>
</div>
<div class="form-group">
  <label for="fine" class="col-sm-2 control-label">{{ trans('tables.fine') }}</label>
  <div class="col-sm-2">{!! Form::text('fine', $penalty->fine, ['class' => 'form-control']) !!}</div>
</div>
<div class="form-group">
