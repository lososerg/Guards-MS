...
<head>
	...
	<title>Editing fine for case # {{ $case->id }}</title>
...
{!! Form::open(['action' => 'CasesController@changePenalty']) !!}
...
<div class="form-group">
  ...
  <div class="col-sm-2">{!! Form::text('fine', $case->fine, ['class' => 'form-control']) !!}</div>
</div>
<div class="form-group">
